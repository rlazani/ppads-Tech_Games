...
--
-- Database: `cadastroGames`
--
CREATE DATABASE IF NOT EXISTS `cadastroGames` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `cadastroGames`;
...
INSERT INTO `games` (`id`, `titulo`, `tipo`, `resumo`, `url`) VALUES

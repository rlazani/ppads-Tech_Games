...
2 - Pasta hotdocs:
O arquivo zip da tag v2 deve ser instalado dentro da pasta xampp/hotdocs
...
O banco de dados da aplicação pode ser acessado via Browser digitando o endereço localhost/phpmyadmin. Depois clicar na aba MySQl para inserir os comandos de criação SQL

5- Acessando o aplicativo:
O aplicativo pode ser acessado no endereço localhost/gbg

<?php
  ...
  $membroData = $membroDao->verifyToken(false);
  ...
  <header>
    <nav id="main-navbar" class="navbar navbar-expand-lg">
      <a href="<?= $BASE_URL ?>" class="navbar-brand">
        ...
        <span id="moviestar-title">Good Browser Games</span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav">
          ...
          <?php elseif($membroData): ?>


            <li class="nav-item">
              <a href="<?= $BASE_URL ?>editprofile_membro.php" class="nav-link bold">
                 Início
              </a>
            </li>

            <li class="nav-item">
              <a href="<?= $BASE_URL ?>recomendacoes.php" class="nav-link">Recomendações</a>
            </li>
